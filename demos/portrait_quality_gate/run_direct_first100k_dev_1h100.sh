...
export DIRECT_EXECUTION_MODE="${DIRECT_EXECUTION_MODE:-staged-block}"
export DIRECT_STAGE_BLOCK_SIZE="${DIRECT_STAGE_BLOCK_SIZE:-2000}"
...
export DIRECT_MAX_CACHE_FILES="${DIRECT_MAX_CACHE_FILES:-2500}"
export DIRECT_MAX_CACHE_BYTES="${DIRECT_MAX_CACHE_BYTES:-42949672960}"
